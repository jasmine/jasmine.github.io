...
<div class="main-content api-docs">
  ...
  <div class="docs">
    <h1 class="page-title">Module: jasmine-core</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Note: Only available on Node.</p></div>
...
<dl class="details">
    ...
    <h4 class="name" id=".boot"><span class="type-signature">(static) </span>boot<span class="signature">(reinitialize<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="jasmine.html">jasmine</a>}</span></h4>
...
<span class="param-type"><a href="jasmine.html">jasmine</a></span>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>const {describe, beforeEach, it, expect, jasmine} = require('jasmine-core').noGlobals();</code></pre>
