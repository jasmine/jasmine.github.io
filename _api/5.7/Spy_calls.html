...
<div class="main-content api-docs">
  ...
  <div class="docs">
    <h1 class="page-title">Namespace: calls</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="Spy.html">Spy</a>#</span>calls</h2>
...
<dl class="details">
    ...
    <h4 class="name" id="all"><span class="type-signature"></span>all<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;<a href="Spy.html#.callData">Spy.callData</a>>}</span></h4>
...
<span class="param-type">Array.&lt;<a href="Spy.html#.callData">Spy.callData</a>></span>
    ...
    <h4 class="name" id="allArgs"><span class="type-signature"></span>allArgs<span class="signature">()</span><span class="type-signature"> &rarr; {Array}</span></h4>
...
<span class="param-type">Array</span>
    ...
    <h4 class="name" id="any"><span class="type-signature"></span>any<span class="signature">()</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id="argsFor"><span class="type-signature"></span>argsFor<span class="signature">(index)</span><span class="type-signature"> &rarr; {Array}</span></h4>
...
<span class="param-type">Array</span>
    ...
    <h4 class="name" id="count"><span class="type-signature"></span>count<span class="signature">()</span><span class="type-signature"> &rarr; {Integer}</span></h4>
...
<div class="description">
    <p>Get the number of invocations of this spy.</p>
</div>
...
<span class="param-type">Integer</span>
    ...
    <h4 class="name" id="first"><span class="type-signature"></span>first<span class="signature">()</span><span class="type-signature"> &rarr; {ObjecSpy.callData}</span></h4>
...
<span class="param-type">ObjecSpy.callData</span>
    ...
    <h4 class="name" id="mostRecent"><span class="type-signature"></span>mostRecent<span class="signature">()</span><span class="type-signature"> &rarr; {ObjecSpy.callData}</span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id="saveArgumentsByValue"><span class="type-signature"></span>saveArgumentsByValue<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id="thisFor"><span class="type-signature"></span>thisFor<span class="signature">(index)</span><span class="type-signature"> &rarr; (nullable) {Object}</span></h4>
